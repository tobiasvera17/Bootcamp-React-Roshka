...
function Info(props) {
  ...
  let link_whatsapp = String(
    `https://api.whatsapp.com/send?text=*SOLICITUD DONACIÓN DE SANGRE*\n` +
      `Nombre Donatario: ` +
      encodeURIComponent(`${props.data.nombre_apellido_donatario}\n`) +
      `Teléfono: ` +
      encodeURIComponent(`${props.data.telefono_contacto}\n`) +
      `C.I: ` +
      encodeURIComponent(`${props.data.cedula_donatario}\n`) +
      `Lugar donación: ` +
      encodeURIComponent(`${props.data.establecimiento}\n`) +
      `RH: ` +
      encodeURIComponent(`${type[props.data.tipo_sangre - 1]} \n`) +
      `Volumenes Necesarios: ` +
      encodeURIComponent(`${props.data.volumenes_necesarios}\n`) +
      `Fecha Limite: ` +
      encodeURIComponent(`${props.data.fecha_limite}\n`) +
      `Solicitud: ` +
      encodeURIComponent(`${props.data.solicitud}\n`) +
      `Link: ` +
      encodeURIComponent(
        `${window.location.protocol}//${window.location.host}` +
          `/index.html#info-container-${props.idContainer}`
      )
  );
  ...
  return (
    <>
      ...
      >
            ...
            <tbody>
              <tr>
                ...
                <td className="text-end fw-bold">
                  {props.data.telefono_contacto}
                </td>
              </tr>
              <tr>
                <td>C.I:</td>
                <td className="text-end fw-bold">
                  {props.data.cedula_donatario}
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td className="text-end">
                  <img
                    className="icon-sangre"
                    src={
                      "./images/icons_sangre/" + props.data.tipo_sangre + ".png"
                    }
                  />
                </td>
              </tr>
              <tr>
                <td>Volúmenes:</td>
                <td className="text-end fw-bold">
                  {props.data.volumenes_necesarios}
                </td>
              </tr>
              <tr>
                <td>Fecha límite:</td>
        ...
        <div className="footer-info-container container-fluid text-center text-uppercase fw-bold">
          {props.data.solicitud}
        </div>
      </div>
    </>
  );
